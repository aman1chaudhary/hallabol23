        ...
        <>
            <div className='main-container'>
                <div className="section">
                    ...
                    <input type="text" placeholder="Team Member 7 Name" className="form-control" name="Team Member 7 Name" required /> 
                    <input type="text" placeholder="Team Member 7 Roll Number" className="form-control" name="Team Member 7 Roll Number" required />
                    <input type="text" placeholder="Team Member 8 Name" className="form-control" name="Team Member 8 Name"  /> 
                    <input type="text" placeholder="Team Member 8 Roll Number" className="form-control" name="Team Member 8 Roll Number"  /> 
                    <input type="text" placeholder="Team Member 9 Name" className="form-control" name="Team Member 9 Name"  /> 
                    <input type="text" placeholder="Team Member 9 Roll Number" className="form-control" name="Team Member 9 Roll Number" /> 
...
export default KhoKhoRegistration