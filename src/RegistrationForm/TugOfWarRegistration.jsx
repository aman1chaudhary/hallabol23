            ...
            <div className='main-container'>
                <div className="section">
                    <div className="registration-form-heading">
                        <h1>Tug of War Registration</h1>
                    </div>
                    <form name="submit-to-google-sheet" className="registration-form" data-form onSubmit={handleSubmit}>
                    <input type="text" placeholder="Male Team/Female Team(Category)" className="form-control" name="Category" required /><br/>
...
export default TugOfWarRegistration